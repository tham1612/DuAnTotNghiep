                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-5">trong danh sách :
                                        ...
                                        <div class="col-12 d-flex mt-3">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between rounded p-3 text-white cursor-pointer"
                                                    ...
                                                    <i class="@if ($memberFollow == 0) ri-eye-off-line @elseif($memberFollow == 1) ri-eye-line @endif
                                                    fs-22"
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="ps-4">
                                            <textarea name="description" id="description_{{ $task->id }}" cols="25" rows="5"
                                                class="form-control bg-light" placeholder="Thêm mô tả chi tiết" onchange="updateTask2({{ $task->id }})">{{ $task->description }}</textarea>
                                        </div>
                                    </div>
                                    <!-- tệp -->
                                    <div class="row mt-3">
