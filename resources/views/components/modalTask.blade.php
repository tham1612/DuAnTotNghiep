                    ...
                    <div class="d-flex">
                        ...
                        <div class="ms-2 w-100">
                            <form class="flex-column" id="comment_form_{{ $task->id }}" style="display: none;"
                                ...
                                <textarea name="content" class="form-control editor" id="comment_task_{{ $task->id }}"
                                    placeholder="Viết bình luận" oninput="toggleSubmitButton({{ $task->id }})"></textarea>

                                <button type="button" id="submit_button_{{ $task->id }}"
                                    class="btn btn-primary mt-2"
                                    onclick="addTaskComment({{ $task->id }}, {{ Auth::id() }})" disabled>
                                    Lưu
                                </button>
                            </form>
                        ...
                        @foreach ($task->task_comments as $comment)
                            ...
                            <div class="d-flex mt-2">
                                ...
                                <section class="ms-2 w-100">
                                    ...
                                    @else
                                        <span class="fs-11">{{ $createdAt->format('H:i j \t\h\g m, Y') }}</span>
                                    @endif
                                    <div class="bg-info-subtle p-1 rounded ps-2">{!! $comment->content !!}
                                    </div>
