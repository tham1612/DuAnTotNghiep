            ...
            <div class="row">
                ...
                <div class="col-12 d-flex flex-wrap">
                    ...
                    <div class="p-3">
                        ...
                        @endphp
                        <div class="d-flex mt-1 align-items-center justify-content-between rounded cursor-pointer"
                            style="background-color: #091e420f; color: #172b4d" id="notification_{{ $task->id }}"
                            onclick="updateTaskMember({{ $task->id }}, {{ $userId }})">
                            <i class="@if ($memberFollow == 1) ri-eye-line @else ri-eye-off-line @endif fs-14 m-1"
                                id="notification_icon_{{ $task->id }}"></i>
                            <p class="m-1" id="notification_content_{{ $task->id }}">
                                @if ($memberFollow == 1)
                                    Đang theo dõi
                                @else
                                    Theo dõi
        ...
        <div class="col-3">
            ...
            <div class="d-flex mt-3 mb-3 cursor-pointer">
                <div class="d-flex align-items-center justify-content-flex-start rounded fw-medium fs-15 p-3 w-100"
                    ...
                    <p class="ms-2 mt-3" data-bs-toggle="<div class="modal-header p-3
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-3">Trong danh sách :
                                            <strong>{{ $task->catalog->name }}</strong> </span>
                                ...
                                <div class="col-12 d-flex flex-wrap">
                                    ...
                                    <div class="p-3">
                                        ...
                                        @php
                                            ...
                                            //                                                        ->where('user_id', $userId)
                                            //                                                        ->value('follow');
                                            $memberFollow1 = collect($task->follow_members)->firstWhere(
                                                'user_id',
                                                $userId,
                                            );
                                            $memberFollow = $memberFollow1 ? $memberFollow1->follow : 0;
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="ps-4">
                                    ...
                                    <div class="bg-info-subtle rounded pt-2 ps-2 d-flex align-items-start"
                                        ...
                                        style="height: 80px; cursor: pointer;" data-task-id="{{ $task->id }}"
