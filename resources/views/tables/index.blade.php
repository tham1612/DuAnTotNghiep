                    ...
                    <table id="task-list" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                        ...
                        @foreach ($tasks as $task)
                            <tr>
                                ...
                                <td >
                                    <form action="{{ route('tasks.update', $task->id) }}" method="POST" id="{{$task->id}}updateTaskForm">
                                        @csrf
                                        @method('PUT')
                                        <select name="catalog_id" id="catalogSelect" class="form-select" onchange="document.getElementById('{{$task->id}}updateTaskForm').submit();">
                                ...
                                <td class="col-2">
                                    <div id="member1" data-bs-toggle="dropdown" aria-expanded="false" class="cursor-pointer">
                                        <div class="avatar-group d-flex justify-content-center" id="newMembar">
                                            ...
                                            @else
                                                <span >
                                                    <i class="bx bxs-user-plus cursor-pointer" data-bs-toggle="tooltip" title="Thêm thành viên"></i>
                                                </span>
                                            @endif
                                        </div>
