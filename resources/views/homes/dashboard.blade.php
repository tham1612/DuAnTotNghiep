            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ asset('theme/assets/images/brands/slack.png') }}" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview.html" class="text-body">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                ...
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ asset('theme/assets/images/users/avatar-4.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
