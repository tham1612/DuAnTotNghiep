...
<form class="taskFormAdd formItem" data-task-id="{{ $taskId }}">
    <div class="mt-2">
        ...
        <input type="text" class="form-control name_checkList" id="name_checkList_{{ $taskId }}" placeholder="Việc cần làm" required />
    </div>
    <div class="mt-2">
        <button type="button" class="btn btn-primary create_checkList" onclick="submitAddCheckList({{ $taskId }}, this)" disabled>
            Thêm
        </button>
    </div>
</form>
