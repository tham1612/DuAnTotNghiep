                ...
                <form class="dropdown-menu dropdown-menu-md p-3" style="width: 35%;max-height: 75vh" data-simplebar
                    ...
                    <div class="mt-2">
                        ...
                        <label for="it_me" class="cursor-pointer">
                            <input type="checkbox" name="it_me" id="it_me" @checked(isset($_GET['it_me']) ? $_GET['it_me'] : '') />
                    ...
                    <div class="mt-2">
                        ...
                        <label for="no_date" class="cursor-pointer">
                            <input type="checkbox" name="no_date" id="no_date" @checked(isset($_GET['no_date']) ? $_GET['no_date'] : '') />
                            <span>Không có ngày hết hạn</span>
                        </label>
                        <br />
                        <label for="no_overdue" class="cursor-pointer">
                            <input type="checkbox" name="no_overdue" id="no_overdue" @checked(isset($_GET['no_overdue']) ? $_GET['no_overdue'] : '') />
                            <span>Quá hạn</span>
                        </label>
                        <br />
...
@if(!empty($boardMembers))
                        ...
                        @if (!$boardMemberChecked || isset($boardMemberChecked) && $boardMemberChecked->is_accept_invite == 1)
                            <div class="bg-opacity-50 bg-dark p-1 rounded">
                                ...
                                <a href="{{ route('b.requestToJoinBoard', request()->route('id')) }}"
                                    id="joinBoardButton" data-bs-toggle="modal" class="avatar-group-item">
